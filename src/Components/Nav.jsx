...
const Nav = ({isAuthenticated, user, logout, authenticate, handleClick, click, setClick, setRefresh}) => {  
      const authUser = () => {
          if(!isAuthenticated){
              authenticate();
              setRefresh(true);
    ...
    <div className='flex  p-8 justify-between relative items-center'>
        ...
        <div className="btns flex">
         ...
         <div className=" rounded pt-4 lg:pt-0 lg:pl-3">
             ...
             <div >
                 <p>Score: <button onClick={logout} ><span>{user.attributes.ethAddress.toString().slice(0,5) + '...'}</span></button></p>
